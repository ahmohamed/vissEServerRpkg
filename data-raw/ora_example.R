...
ora_example = ora(.silent = FALSE, genes$gene_name, org = "hsapiens", idtype = "external_gene_name", collections = c("CP:REACTOME", "CP:BIOCARTA", "CP:PID", "CP:KEGG", "CP:WIKIPATHWAYS", "h", "GO:BP", "GO:CC", "GO:MF"))
